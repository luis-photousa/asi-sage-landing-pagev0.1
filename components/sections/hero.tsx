...
export function Hero() {
	return (
		<section className="relative overflow-hidden bg-[url('https://photousacorp.com/cdn/shop/files/Banner_40-TravelTumbler_03_1880_720_2x_q92.webp?v=1710867461&width=3840')] h-full w-full bg-cover bg-center">
